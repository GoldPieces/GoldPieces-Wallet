...
const string strMessageMagic = "GoldPieces Signed Message:\n";
...
uint256 CBlockIndex::GetBlockTrust() const
{
    ...
    CBigNum bt = ((CBigNum(1)<<256) / (bnTarget+1));
    return bt.getuint256();
}
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GoldPieces", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Sun, 04 Jan 2015 12:18:31 GMT";
        CTransaction txNew;
        txNew.nTime = 1420373913;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x48cb23eb382df669c11777f1c741727f69ad518d2c0ecf8b37c6270f0a9e68bb"));
        block.print();
